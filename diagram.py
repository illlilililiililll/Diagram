...
class Diagram():
    ...
    def Triangluation(self, imgshow=True, circle=False):
        ...
        for t in triangles:
            ...
            self.trianges.append((pt1, pt2, pt3))
            ...
            if circle:
                ...
                import random
                try:
                    cv2.circle(delaunay_img, (round(center_x), round(center_y)), round(radius), (random.randint(9, 255), random.randint(9, 255), random.randint(9, 255)), 1, lineType=cv2.LINE_AA)
                except ValueError:
                    pass
